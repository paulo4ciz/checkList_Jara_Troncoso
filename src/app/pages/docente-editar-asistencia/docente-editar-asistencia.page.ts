...
@Component({
  selector: 'app-docente-editar-asistencia',
  templateUrl: './docente-editar-asistencia.page.html',
  styleUrls: ['./docente-editar-asistencia.page.scss'],
})
export class DocenteEditarAsistenciaPage implements OnInit {
